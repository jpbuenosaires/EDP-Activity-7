...
namespace EcommerceIS
{
    public class FrmReportGenerator : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            tthis.FormBorderStyle = FormBorderStyle.None;
...
this.WindowState     = FormWindowState.Maximized;
        ...
        private void BuildHeader()
        {
            ...
            {
                Text      = "Generate, filter, and export reports from the EcommerceDB database.",
        ...
        private void BuildLeftPanel()
        {
            ...
            btnExportExcel.Click += (s, e) =>
                MessageBox.Show("Export to Excel feature is available.\nRequires ClosedXML NuGet package.",
