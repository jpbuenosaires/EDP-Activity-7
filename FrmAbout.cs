...
namespace EcommerceIS
{
    public class FrmAbout : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Resize += (s, e) => pnlCenter.Left = (this.ClientSize.Width - pnlCenter.Width) / 2;
            this.Controls.Add(pnlCenter);

            // ── Info rows ─────────────────────────────────────
            int y = 20;
            AddInfoRow("👤  Developed by",  "Jayson Buenosaires",                 ref y, pnlCenter);
            AddInfoRow("🏫  Institution",   "Bicol University — College of Science", ref y, pnlCenter);
            AddInfoRow("📚  Program",       "BS Information Technology",          ref y, pnlCenter);
            AddInfoRow("📘  Course",        "IT 120 — Event Driven Programming",  ref y, pnlCenter);
            AddInfoRow("📅  School Year",   "2025–2026  |  Second Semester",      ref y, pnlCenter);
            AddInfoRow("🗄️  Database",      "MySQL 8.0  ·  EcommerceDB",          ref y, pnlCenter);
            AddInfoRow("💻  Platform",      "C#  ·  .NET Framework  ·  WinForms", ref y, pnlCenter);
